...
Hooks.on('dropActorSheetData', async (actor, html, item) => {
  ...
  let traits = actor.system.attributes
...
Hooks.on('renderActorSheet', async function (app, html, data) {
  ...
  if (actor.type == 'character') {
    ...
    let addInjuryFive = actor.system.attributes.resource.options['0'].values['4'].value
    let addInjurySix = actor.system.attributes.resource.options['0'].values['6'].value
    let addInjurySeven = actor.system.attributes.resource.options['0'].values['8'].value
    let addInjuryEight = actor.system.attributes.resource.options['0'].values['10'].value
    ...
    let addExhaustionFive = actor.system.attributes.resource.options['1'].values['4'].value
    let addExhaustionSix = actor.system.attributes.resource.options['1'].values['6'].value
    let addExhaustionSeven = actor.system.attributes.resource.options['1'].values['8'].value
    let addExhaustionEight = actor.system.attributes.resource.options['1'].values['10'].value
    ...
    let addDepletionFive = actor.system.attributes.resource.options['2'].values['4'].value
    let addDepletionSix = actor.system.attributes.resource.options['2'].values['6'].value
    let addDepletionSeven = actor.system.attributes.resource.options['2'].values['8'].value
    let addDepletionEight = actor.system.attributes.resource.options['2'].values['10'].value
  ...
  if (actor.type == 'npc') {
    ...
    let addNPCInjuryTwo = actor.system.attributes.injury.options['0'].values['1'].value
    let addNPCInjuryThree = actor.system.attributes.injury.options['0'].values['3'].value
    let addNPCInjuryFour = actor.system.attributes.injury.options['0'].values['5'].value
    let addNPCInjuryFive = actor.system.attributes.injury.options['0'].values['7'].value
    let addNPCInjurySix = actor.system.attributes.injury.options['0'].values['9'].value
    let addNPCInjurySeven = actor.system.attributes.injury.options['0'].values['11'].value
    let addNPCInjuryEight = actor.system.attributes.injury.options['0'].values['13'].value
    let addNPCInjuryNine = actor.system.attributes.injury.options['0'].values['15'].value
    let addNPCInjuryTen = actor.system.attributes.injury.options['0'].values['17'].value
    let addNPCInjuryEleven = actor.system.attributes.injury.options['0'].values['19'].value
    let addNPCInjuryTwelve = actor.system.attributes.injury.options['0'].values['21'].value
    ...
    let addNPCExhaustionTwo = actor.system.attributes.exhaustion.options['0'].values['1'].value
    let addNPCExhaustionThree = actor.system.attributes.exhaustion.options['0'].values['3'].value
    let addNPCExhaustionFour = actor.system.attributes.exhaustion.options['0'].values['5'].value
    let addNPCExhaustionFive = actor.system.attributes.exhaustion.options['0'].values['7'].value
    let addNPCExhaustionSix = actor.system.attributes.exhaustion.options['0'].values['9'].value
    let addNPCExhaustionSeven = actor.system.attributes.exhaustion.options['0'].values['11'].value
    let addNPCExhaustionEight = actor.system.attributes.exhaustion.options['0'].values['13'].value
    let addNPCExhaustionNine = actor.system.attributes.exhaustion.options['0'].values['15'].value
    let addNPCExhaustionTen = actor.system.attributes.exhaustion.options['0'].values['17'].value
    let addNPCExhaustionEleven = actor.system.attributes.exhaustion.options['0'].values['19'].value
    let addNPCExhaustionTwelve = actor.system.attributes.exhaustion.options['0'].values['21'].value
    ...
    let addNPCWearTwo = actor.system.attributes.wear.options['0'].values['1'].value
    let addNPCWearThree = actor.system.attributes.wear.options['0'].values['3'].value
    let addNPCWearFour = actor.system.attributes.wear.options['0'].values['5'].value
    let addNPCWearFive = actor.system.attributes.wear.options['0'].values['7'].value
    let addNPCWearSix = actor.system.attributes.wear.options['0'].values['9'].value
    let addNPCWearSeven = actor.system.attributes.wear.options['0'].values['11'].value
    let addNPCWearEight = actor.system.attributes.wear.options['0'].values['13'].value
    let addNPCWearNine = actor.system.attributes.wear.options['0'].values['15'].value
    let addNPCWearTen = actor.system.attributes.wear.options['0'].values['17'].value
    let addNPCWearEleven = actor.system.attributes.wear.options['0'].values['19'].value
    let addNPCWearTwelve = actor.system.attributes.wear.options['0'].values['21'].value
    ...
    let addNPCMoraleTwo = actor.system.attributes.morale.options['0'].values['1'].value
    let addNPCMoraleThree = actor.system.attributes.morale.options['0'].values['3'].value
    let addNPCMoraleFour = actor.system.attributes.morale.options['0'].values['5'].value
    let addNPCMoraleFive = actor.system.attributes.morale.options['0'].values['7'].value
    let addNPCMoraleSix = actor.system.attributes.morale.options['0'].values['9'].value
    let addNPCMoraleSeven = actor.system.attributes.morale.options['0'].values['11'].value
    let addNPCMoraleEight = actor.system.attributes.morale.options['0'].values['13'].value
    let addNPCMoraleNine = actor.system.attributes.morale.options['0'].values['15'].value
    let addNPCMoraleTen = actor.system.attributes.morale.options['0'].values['17'].value
    let addNPCMoraleEleven = actor.system.attributes.morale.options['0'].values['19'].value
    let addNPCMoraleTwelve = actor.system.attributes.morale.options['0'].values['21'].value
